            ...
            {data.map((item, index) => (
                <SwiperSlide key={item.id || index}>
                    ...
                    <div className="my-8 flex items-center  flex-col  w-full mx-auto  ">
                        <div className="p-4 w-[80px] h-[80px] sm:w-[119px] text-center sm:h-[119px] dark:bg-[#00FFFF] bg-[#F7F7F7]  align-super shadow-md rounded-lg flex items-center justify-center mb-2 group transition-transform transform hover:scale-105 hover:shadow-2xl">
